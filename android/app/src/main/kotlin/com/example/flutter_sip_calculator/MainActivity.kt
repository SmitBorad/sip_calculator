package com.phonix.sip.calculator
...
class MainActivity: FlutterActivity() {
    ...
    override fun cleanUpFlutterEngine(flutterEngine: FlutterEngine) {
        ...
        GoogleMobileAdsPlugin.unregisterNativeAdFactory(flutterEngine, "adSmall")
    }
}
...
class NativeAdFactorySmall: NativeAdFactory {
    ...
    override fun createNativeAd(nativeAd: NativeAd?, customOptions: MutableMap<String, Any>?): NativeAdView {
        val adView = layoutInflater.inflate(R.layout.native_small, null) as NativeAdView
